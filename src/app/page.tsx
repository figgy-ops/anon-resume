...
const projects = [
  ...
  },
  {
    ...
    description:
      "Rebuilt the intranet for a large SharePoint environment with distributed ownership.",
    implementation:
  ...
  },
  {
    ...
    implementation:
      "Developed React and Next.js interfaces for public and professional-services sites, with WCAG requirements built into the implementation.",
...
const experience = [
  {
    ...
    detail:
      "Automation, systems integration, enterprise applications, SharePoint and Power Platform administration, governance, identity, reporting, and technical support across a distributed environment.",
  },
  {
    period: "Earlier scope",
  ...
  },
  {
    ...
    title: "IT Specialist",
    employer: "Professional-services organization",
    detail:
    ...
    <main id="top">
      ...
      <header className="site-header">
        <div className="container header-inner">
          <a className="brand" href="#top" aria-label="Technical portfolio, home">
            Technical Portfolio
          </a>
      ...
      <div id="content">
          ...
          <div className="container">
            <div className="intro-heading">
              <div>
                ...
                <h1 id="intro-heading">Technical Portfolio</h1>
              </div>
              <div className="contact-strip" aria-label="Résumé shortcuts">
                <a href="#experience">Experience</a>
            ...
            <p className="summary">
              ...
              and internal platforms in a distributed organizational environment.
            ...
            <dl className="profile-grid">
              ...
              <div>
                <dt>Environment</dt>
                <dd>Distributed · multi-site · cloud and on-premises</dd>
              </div>
              <div>
                <dt>Core tools</dt>
        ...
        <section className="contact" id="contact" aria-labelledby="contact-heading">
          <div className="container contact-inner">
            <div>
              <p className="section-index">06 / Profile</p>
              <h2 id="contact-heading">Résumé navigation</h2>
            </div>
            <div className="contact-details">
              <a href="#top">Overview</a>
              <a href="#experience">Experience</a>
              <a href="#skills">Technical profile</a>
            </div>
          </div>
        </section>
      </div>
